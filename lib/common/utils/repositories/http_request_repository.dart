...
class HttpRequestRepository implements HttpRequestInterFace {
  ...
  @override
  String get baseUrl => "https://iraq-car_verification_system.com";
  // String get testBaseUrl => "https://iraq-car_verification_system.com";

  final LogStorage logs = LogStorage();


  Dio dio = Dio(BaseOptions(baseUrl: "https://iraq-car_verification_system.com/api", followRedirects: false))
